...
const projects = [
  ...
  {
    id: "labour-city-80",
    name: "Labour City (80 Yds Res)",
    basePrice: 600000,
    todayMarketRate: 600000,
    minDown: 33, // 200k booking
    maxDown: 50,
    tenures: [12, 24],
    defaultTenure: 12,
    location: "Scheme 45, Northern Bypass (Survey 398, 398/1)",
    size: "80 Sq Yards Residential",
    color: "#D4AF37",
  },
  {
    id: "labour-city-150-comm",
    name: "Labour City (150 Yds Comm)",
    basePrice: 1350000,
    todayMarketRate: 1350000,
    minDown: 22, // 300k booking
    maxDown: 40,
    tenures: [12, 24],
    defaultTenure: 12,
    location: "Scheme 45, Northern Bypass (Survey 398, 398/1)",
